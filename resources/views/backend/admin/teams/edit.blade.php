            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-title">{{ __('Update Team') }}</h6>
                        <a class="btn btn-outline-primary float-end" href="{{ route('admin.teams.index') }}"
                            style="margin-top: -38px;">{{ __('All Team') }}</a>

                        <form class="forms-sample" method="POST" action="{{ route('admin.teams.update', $team->id) }}"
                                ...
                                <div class="col-md-9">
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            ...
                                            <select class="js-example-basic-single form-select" data-width="100%"
                                                ...
                                                <option value="Management" @if ($team->category == 'Management') {{ 'selected' }} @endif>{{ __('Management') }}
                                                </option>
                                                <option value="Advisor" @if ($team->category == 'Advisor') {{ 'selected' }} @endif>{{ __('Advisor') }}
                                                </option>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{ __('Name') }}"
                                                autocomplete="off" name="name" id="name" value="{{ $team->name }}"
                                                required="" />
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="editor" name="detail" />{{ $team->detail }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card" style="margin-top: 28px">
                                        <div class="card-body">
                                            <center>
                                                <img src="{{ asset($team->photo) }}" id="user-photo"
