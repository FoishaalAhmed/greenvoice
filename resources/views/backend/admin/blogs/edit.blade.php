            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-title">{{ __('Update Blog') }}</h6>
                        <a class="btn btn-outline-primary float-end" href="{{ route('admin.blogs.index') }}"
                            style="margin-top: -38px;">{{ __('All Blog') }}</a>

                        <form class="forms-sample" method="POST" action="{{ route('admin.blogs.update', $blog->id) }}"
                            ...
                            <div class="row">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control date datepicker" placeholder="{{ __('Date') }}"
                                                autocomplete="off" name="date" id="datePickerExample" value="{{ $blog->date }}"
                                                required="" />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">{{ __('Title') }}</label>
                                            <input type="text" class="form-control" placeholder="{{ __('Title') }}"
                                                autocomplete="off" name="title" id="title" value="{{ $blog->title }}"
                                                required="" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{ __('Slug') }}"
                                                autocomplete="off" name="slug" id="slug" value="{{ $blog->slug }}"
                                                required="" />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">{{ __('Writer') }}</label>
                                            <input type="text" class="form-control" placeholder="{{ __('Writer') }}" autocomplete="off" name="writer" id="writer" value="{{ $blog->writer }}"
                                             />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="card" style="margin-top: 28px">
                                        <div class="card-body">
                                            <center>
                                                <img src="{{ asset($blog->photo) }}" id="user-photo" style="width: 100px; height: 100px">
