...
<head>
    ...
    <title>Green Voice | @yield('title') </title>
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown"
                        ...
                        <img src="{{ asset('public/frontend/assets/img/ca.png') }}" class="flag-width" alt="flag">
                    </a>
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('public/frontend/assets/img/de.png') }}" class="flag-width"
                                alt="flag"> <span class="align-self-center">&nbsp;German</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('public/frontend/assets/img/jp.png') }}" class="flag-width"
                                alt="flag"> <span class="align-self-center">&nbsp;Japanese</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('public/frontend/assets/img/fr.png') }}" class="flag-width"
                                alt="flag"> <span class="align-self-center">&nbsp;French</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img
                                src="{{ asset('public/frontend/assets/img/ca.png') }}" class="flag-width"
                        ...
                        <div class="">
                            ...
                            <a class="dropdown-item">
                                <div class="">
                                    <div class="media">
                                        <div class="user-img">
                                            <img src="{{ asset('public/frontend/assets/img/profile-15.jpg') }}"
                ...
                <li class="nav-item dropdown user-profile-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown"
                        ...
                        <img src="{{ asset('public/frontend/assets/img/profile-16.jpg') }}" alt="avatar">
                    </a>
